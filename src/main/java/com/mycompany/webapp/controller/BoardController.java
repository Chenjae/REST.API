...
public class BoardController {
	...
	//mutlipart/form-data 형식으로 데이터를 전송할 때에는 PUT, PATCH를 사용할 수 없다.
	//POST 방식만 가능
	@PostMapping("/update")
	...
	public void download(@PathVariable int bno, HttpServletResponse response) {
		try {
			...
			InputStream is = new FileInputStream("C:/Temp/upload/" + battachsname);
